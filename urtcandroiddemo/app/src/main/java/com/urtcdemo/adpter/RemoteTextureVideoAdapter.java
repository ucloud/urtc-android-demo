...
public class RemoteTextureVideoAdapter extends RecyclerView.Adapter<RemoteTextureVideoAdapter.ViewHolder> {
    ...
    private HashMap<String, URTCTextureVideoViewInfo> mStreamViews = new HashMap<>();
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        URTCTextureVideoViewInfo viewInfo = mStreamViews.get(mkey);
        if (viewInfo == null) {
            return;
        }
        if (holderView.getChildCount() == 0) {
    ...
    public HashMap<String, URTCTextureVideoViewInfo> getStreamViews() {
        return mStreamViews;
    }
